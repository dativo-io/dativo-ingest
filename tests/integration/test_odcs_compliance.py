...
def validate_asset(asset_path, schema):
    ...
    try:
        ...
        if 'compliance' in odcs_data:
            ...
            if 'classification' in compliance and not isinstance(compliance['classification'], list):
                errors.append("compliance.classification must be an array")
            if 'regulations' in compliance and not isinstance(compliance['regulations'], list):
        ...
        if 'finops' in odcs_data:
            ...
            if 'business_tags' in finops and not isinstance(finops['business_tags'], list):
