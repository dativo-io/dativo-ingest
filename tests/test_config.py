...
class TestJobConfigLoading:
    ...
    def test_load_job_with_invalid_infrastructure_tags(self, temp_dir, valid_asset_file):
    ...
    def test_load_job_with_invalid_provider_runtime_combo(self, temp_dir, valid_asset_file):
    ...
    def test_load_job_with_environment_mismatch(self, temp_dir, valid_asset_file):
