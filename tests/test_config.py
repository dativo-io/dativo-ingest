...
def valid_job_config(temp_dir):
    ...
    config_data = {
        ...
        "source_connector_path": "tests/fixtures/connectors/stripe.yaml",
...
class TestJobConfigLoading:
    ...
    def test_load_valid_job_config(self, valid_job_config, valid_asset_file):
        ...
        assert config.source_connector_path == "tests/fixtures/connectors/stripe.yaml"
        assert config.target_connector_path == "tests/fixtures/connectors/iceberg.yaml"
